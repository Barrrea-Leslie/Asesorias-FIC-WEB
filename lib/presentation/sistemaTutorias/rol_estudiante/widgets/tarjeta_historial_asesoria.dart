...
import 'package:asesorias_fic/presentation/sistemaTutorias/rol_estudiante/asesoriasEnCurso/material_estudiante.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Horario: ${item.horariosAsesora.isNotEmpty ? item.horariosAsesora[0] : 'No asignado'}",
                          style: const TextStyle(
                            color: Colors.white70,
                            fontSize: 13,
                          ),
                          ...
                          children: [
                            _BotonAccionHistorial(
                              ...
                              onPressed: () {
                                showDialog(
                                  context: context,
                                  builder: (context) =>
                                      _AlertaInformacionAsesor(asesor: item),
                                );
                              },
                            ),
                            ...
                            _BotonAccionHistorial(
                              ...
                              onPressed: () {
                                showDialog(
                                  context: context,
                                  builder: (context) => MaterialAsesorModal(
                                    nombreAsesor: item.nombre,
                                  ),
                                );
                              },
                            ),
