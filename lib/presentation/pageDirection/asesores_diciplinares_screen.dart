...
class AsesoresDiciplinaresScreen extends StatelessWidget {
  const AsesoresDiciplinaresScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 255, 255, 255),
        title: Text('Asesores Diciplinares', style: TextStyle(fontWeight: FontWeight.bold)),
      ),

      drawer: Mydrawer(rutaActual: '/asesoresDiciplinares'),
      ...
      body: Padding(
        ...
        child: Row(
          children: [
            ...
            //menu
            Mydrawer(rutaActual: '/asesoresDiciplinares'),
