...
class CargaNuevoAsesorDic extends StatefulWidget {
  const CargaNuevoAsesorDic({super.key});

  @override
  State<CargaNuevoAsesorDic> createState() => _CargaNuevoAsesorDicState();
}

class _CargaNuevoAsesorDicState extends State<CargaNuevoAsesorDic> {
  ...
  Future<void> _descargarFormato() async {
    try {
      await descargarFormato(
        assetPath: 'assets/formatos/FormatoAsesoresDiciplinares.xlsx',
        nombreArchivo: 'FormatoAsesoresDiciplinares.xlsx',
