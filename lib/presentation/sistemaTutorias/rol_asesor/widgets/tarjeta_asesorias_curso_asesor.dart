...
import 'package:asesorias_fic/presentation/sistemaTutorias/rol_administrador/asesoriasEnCurso/informacion_asesorias_en_curso.dart';
import 'package:asesorias_fic/presentation/sistemaTutorias/rol_administrador/asesoriasEnCurso/material_adicional.dart';
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Materia: ${asesoriaActual.materia}',
                              style: const TextStyle(
                                color: Colors.white,
                                fontSize: 15,
                              ),
                            ...
                            const SizedBox(height: 5),
                            Text(
                              'Inicio: ${asesoriaActual.fechaInicio}',
                              style: const TextStyle(
                                color: Colors.white,
                                fontSize: 15,
                              ),
                            ...
                            const SizedBox(height: 5),
                            Text(
                              'Horario: ${asesoriaActual.horario}',
                              style: const TextStyle(
                                color: Colors.white,
                                fontSize: 15,
                              ),
                            ...
                            const SizedBox(height: 5),
                            Text(
                              'Modalidad: ${asesoriaActual.modalidad}',
                              style: const TextStyle(
                                color: Colors.white,
                                fontSize: 15,
                              ),
                        ...
                        Column(
                          children: [
                            Row(
                              children: [
                                Expanded(
                                  child: BotonInfo(asesoria: asesoriaActual),
                                ),
