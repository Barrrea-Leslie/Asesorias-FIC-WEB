...
class _CrearAsesoresParState extends State<CrearAsesoresPar> {
  ...
  void _onEstudianteChanged(Estudiantes? est) {
    ...
    setState(() {
      ...
      _selectedLicenciatura = licenciaturas.contains(est.licenciatura)
          ? est.licenciatura
          : null;
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<Estudiantes>(
          ...
          validator: (val) =>
              val == null ? "Debe seleccionar un estudiante" : null,
        ),
      ],
    );
  }
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(promedioController, "0.0"),
                ],
              ),
            ),
          ],
            ...
            onPressed: () {
              if (_formKey.currentState!.validate()) {
                if (materiasSeleccionadas.isEmpty ||
                    horariosSeleccionados.isEmpty) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        "Agregue al menos una materia y un horario",
                      ),
                    ),
                  );
                  return;
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (ctx, i) => ListTile(
                        ...
                        onTap: () {
                          setState(() {
                            if (!materiasSeleccionadas.contains(
                              sugerencias[i],
                            )) {
